...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-zinc-800 last:border-b-0">
      ...
      >
        {/* <p className="text-zinc-400 text-base leading-relaxed px-4 py-3">{answer}</p> */}
      ...
      <div className="max-w-7xl mx-auto px-4 py-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-zinc-900/50 backdrop-blur-lg rounded-xl p-8 border border-zinc-800/50 transform transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-500/5 animate-fade-in relative overflow-hidden"
